 ...
 * @author Admin
 */
public class Xuatfile_ChamCongNhanVienThuViec extends javax.swing.JFrame {

    /**
     * Creates new form Xuatfile_ChamCongNhanVienThuViec
     */
    public Xuatfile_ChamCongNhanVienThuViec() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Xuatfile_ChamCongNhanVienThuViec.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Xuatfile_ChamCongNhanVienThuViec().setVisible(true);
            }
        });
    }
